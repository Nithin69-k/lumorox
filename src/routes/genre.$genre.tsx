  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      <h1 className="text-gradient mt-4 font-display text-3xl tracking-tight sm:text-5xl">
        {genre} Movies, Series & Shows
      </h1>
      <div className="accent-rule mt-2" />
      <p className="mt-3 max-w-2xl text-sm text-muted-foreground">
        Every {genre.toLowerCase()} movie, TV series and show, ordered from the newest releases down to the classics. Keep loading for more.
      </p>
      ...
      <div aria-live="polite" className="mt-10 flex justify-center">
        {hasNextPage ? (
          ...
          >
            ...
            {isFetchingNextPage ? "Loading more…" : `Load more ${genre.toLowerCase()} titles`}
          </button>
        ) : (
          movies.length > 0 && (
